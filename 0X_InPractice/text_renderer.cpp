...
void TextRenderer::DrawText(Text &t) {

    //TODO: draw t.container first, then t.text
    ...
    shader.Use();
    glUniform3f(glGetUniformLocation(shader.ID, "textColor"), t.text_color.x, t.text_color.y, t.text_color.z);
